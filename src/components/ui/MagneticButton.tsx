...
export function MagneticIconButton({
  ...
  const variantStyles = {
    ...
    secondary: "bg-muted/80 text-foreground border border-primary/20",
...
export function MagneticLink({
  ...
  return (
    ...
    >
      ...
      {underline && (
        <motion.span
          className="absolute bottom-0 left-0 w-full h-[2px] bg-gradient-to-r from-primary to-secondary origin-left"
          initial={{ scaleX: 0 }}
          whileHover={{ scaleX: 1 }}
